...
define('set-can-util/js/is-promise/is-promise', function (require, exports, module) {
    module.exports = function (obj) {
        return obj instanceof Promise || Object.prototype.toString.call(obj) === '[object Promise]';
    };
});
/*can-util@3.0.1#js/types/types*/
define('set-can-util/js/types/types', function (require, exports, module) {
    var isPromise = require('set-can-util/js/is-promise/is-promise');
    var types = {
        isMapLike: function () {
            return false;
        },
...
define('set-can-util/js/is-iterable/is-iterable', function (require, exports, module) {
    var types = require('set-can-util/js/types/types');
    module.exports = function (obj) {
...
define('set-can-util/namespace', function (require, exports, module) {
    module.exports = {};
});
/*src/props*/
...
define('can-set', function (require, exports, module) {
    ...
    var ns = require('set-can-util/namespace');

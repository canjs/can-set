...
test("combineRange - basics", function(){
	...
	res = sets.combineRange({start: 200, end: 299}, {start: 100, end: 199}, compareStartAndEnd);
	deepEqual(res, {start:100, end:299}, "default compare works");
	
	res = sets.combineRange({start: 200, end: 299}, {start: 100, end: 209}, compareStartAndEnd);
	deepEqual(res, {start:100, end:299}, "default compare works");
	
	res = sets.combineRange({start: 100, end: 299}, {start: 103, end: 209}, compareStartAndEnd);
	deepEqual(res, {start:100, end:299}, "default compare works");
	
	res = sets.combineRange({start: 100, end: 299}, {start: 100, end: 299}, compareStartAndEnd);
	deepEqual(res, {start:100, end:299}, "default compare works");
});
...
test("diff - basics", function(){
	...
	diff = sets.diff({start: 150, end: 299}, {start: 100, end: 299}, compareStartAndEnd);
	deepEqual(diff, {needs: [100,149], insertNeeds: "before", cached: [150,299], properties: ["start","end"]}, "default diff works");
	
	diff = sets.diff({start: 100, end: 299}, {start: 101, end: 102}, compareStartAndEnd);

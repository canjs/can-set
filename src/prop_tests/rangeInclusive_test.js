...
QUnit.test('rangeInclusive set.subset', function(assert) {
	/*
	 * X = [A0, ..., An]
	 * Y = [A0, ..., An]
	 */
...
QUnit.test('rangeInclusive set.difference', function(assert) {
	...
	assert.equal(res, true, 'universal set');
...
QUnit.test('rangeInclusive with string numbers (#17)', function(assert) {
	...
	assert.deepEqual(res, [{id: 2},{id: 3}], ".getSubset");
	...
	res = algebra.getUnion(
		...
		[{id: 2},{id: 3}],
		[{id: 1},{id: 2},{id: 3},{id: 4}]);
	assert.deepEqual(res, [{id: 1},{id: 2},{id: 3},{id: 4}], ".getUnion");
